          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-[#f8f9fa] rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-medium text-gray-500 bg-white px-2 py-1 rounded-full">
                    {posts?.filter(p => new Date(p.created_at) > new Date(Date.now() - 24*60*60*1000)).length || 0}
                  </span>
                </div>
                <div className="space-y-3">
                  {posts?.filter(p => new Date(p.created_at) > new Date(Date.now() - 24*60*60*1000))
                      ...
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">{post.user_name || '익명'}</p>
                          </div>
                        </div>
              ...
              <div className="bg-[#f8f9fa] rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-medium text-gray-500 bg-white px-2 py-1 rounded-full">
                    {posts?.filter(p => p.view_count >= 100).length || 0}
                  </span>
                </div>
                <div className="space-y-3">
                  {posts?.filter(p => p.view_count >= 100)
            ...
            <div className="mt-8 bg-white rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-sm text-gray-500">총 {posts?.length || 0}개</span>
                </div>
              </div>
                    ...
                    <div className="flex items-start justify-between mb-2" onClick={() => handlePostClick(post.id)}>
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{post.user_name || '익명'}</p>
                        </div>
                      </div>
                      <span className="flex-shrink-0 text-xs text-gray-500 ml-2">
                        {new Date(post.created_at).toLocaleDateString()}
