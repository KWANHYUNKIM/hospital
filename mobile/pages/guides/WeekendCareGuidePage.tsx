...
const WeekendCareGuidePage: React.FC = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>주말진료 이용 가이드</Text>
        <View style={styles.headerSpacer} />
      </View>

      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.contentContainer}>
          <Text style={styles.mainTitle}>주말진료 이용 가이드</Text>
          
          {/* 주말진료란? */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>주말진료란?</Text>
          ...
          {/* 주말진료 이용이 필요한 경우 */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>주말진료 이용이 필요한 경우</Text>
            <View style={styles.listContainer}>
              <View style={styles.listItem}>
                <Text style={styles.bullet}>•</Text>
                <Text style={styles.listText}>평일에는 바빠서 진료를 받지 못한 경우</Text>
              </View>
              <View style={styles.listItem}>
                <Text style={styles.bullet}>•</Text>
                <Text style={styles.listText}>만성 질환의 정기적인 진료가 필요한 경우</Text>
              </View>
              <View style={styles.listItem}>
                <Text style={styles.bullet}>•</Text>
          ...
          {/* 주말진료 찾는 방법 */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>주말진료 찾는 방법</Text>
            <View style={styles.orderedList}>
              <View style={styles.orderedItem}>
                <Text style={styles.orderedNumber}>1.</Text>
                <Text style={styles.orderedText}>삐뽀삐뽀119 앱/웹사이트에서 '주말진료' 필터 선택</Text>
              </View>
              <View style={styles.orderedItem}>
                <Text style={styles.orderedNumber}>2.</Text>
                <Text style={styles.orderedText}>현재 위치 기반으로 가까운 주말진료 병원 검색</Text>
              </View>
              <View style={styles.orderedItem}>
          ...
          {/* 주말진료 이용 시 준비물 */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>주말진료 이용 시 준비물</Text>
            <View style={styles.listContainer}>
              <View style={styles.listItem}>
                <Text style={styles.bullet}>•</Text>
              ...
              <View style={styles.listItem}>
                <Text style={styles.bullet}>•</Text>
                <Text style={styles.listText}>이전 진료 기록 (있는 경우)</Text>
              </View>
            </View>
          </View>
          ...
          {/* 주말진료 이용 시 주의사항 */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>주말진료 이용 시 주의사항</Text>
            <View style={styles.listContainer}>
              <View style={styles.listItem}>
                <Text style={styles.bullet}>•</Text>
                <Text style={styles.listText}>주말진료는 평일 진료와 동일한 서비스입니다</Text>
              </View>
              <View style={styles.listItem}>
                <Text style={styles.bullet}>•</Text>
          ...
          {/* 주말진료 비용 안내 */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>주말진료 비용 안내</Text>
            <View style={styles.costInfoContainer}>
              <View style={styles.costInfoItem}>
                <Text style={styles.costInfoBullet}>•</Text>
                <Text style={styles.costInfoText}>주말진료는 평일 진료와 동일한 비용이 적용됩니다</Text>
              </View>
              <View style={styles.costInfoItem}>
                <Text style={styles.costInfoBullet}>•</Text>
          ...
          {/* 주말진료 이용 팁 */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>주말진료 이용 팁</Text>
            <View style={styles.tipContainer}>
              <View style={styles.tipItem}>
                <Icon name="lightbulb" size={20} color="#F59E0B" />
                <Text style={styles.tipText}>가능한 한 오전에 방문하는 것이 좋습니다</Text>
              </View>
              <View style={styles.tipItem}>
                <Icon name="lightbulb" size={20} color="#F59E0B" />
                <Text style={styles.tipText}>전화로 예약 가능 여부를 미리 확인하세요</Text>
              </View>
              <View style={styles.tipItem}>
                <Icon name="lightbulb" size={20} color="#F59E0B" />
                <Text style={styles.tipText}>증상과 병력을 미리 정리해두세요</Text>
              </View>
              <View style={styles.tipItem}>
                <Icon name="lightbulb" size={20} color="#F59E0B" />
                <Text style={styles.tipText}>필요한 경우 다음 주 평일 진료 예약을 미리 하세요</Text>
              </View>
              <View style={styles.tipItem}>
                <Icon name="lightbulb" size={20} color="#F59E0B" />
                <Text style={styles.tipText}>의료진의 지시사항을 정확히 따라주세요</Text>
              </View>
            </View>
          </View>
